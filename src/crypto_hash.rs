...
mod tests {
    ...
    fn crypto_hash_ok() {
        let m = [1 as u8, 2, 3];
        let expected = [39 as u8, 134, 76, 197, 33, 154, 149, 26, 122, 110, 82,
                        184, 200, 221, 223, 105, 129, 208, 152, 218, 22, 88,
                        217, 98, 88, 200, 112, 178, 200, 141, 251, 203, 81,
                        132, 26, 234, 23, 42, 40, 186, 250, 106, 121, 115, 17,
                        101, 88, 70, 119, 6, 96, 69, 201, 89, 237, 15, 153, 41,
                        104, 141, 4, 222, 252, 41];
